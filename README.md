...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5fdb2c05488d050015e11294
...
To start editing your site, you can use the Sanity interface at https://amazing-oak-b2c05.sanity.studio/.
...
Generated at `2020-12-17T10:00:41.804Z` by Stackbit version `0.3.40`.